...
class BuyerCategoryNameScreen extends StatefulWidget {
  ...
  @override
  _BuyerCategoryNameScreenState createState() => _BuyerCategoryNameScreenState();
}
          ...
          body: Column(
            children: [
              ...
              Padding(
                ...
                child: Text('Search Product', style: AppFont.NUNITO_SEMI_BOLD_BLACK_24),
              ),
                  ...
                  ? Padding(
                      ...
                      child: Container(
                        ...
                        child: DropdownButton<Category>(
                          hint: categoryData == null ? const Text('All Categories') : Text(categoryData!.categoryName!),
                          underline: Container(),
                          isExpanded: true,
                          isDense: true,
                          ...
                          onChanged: (newValue) {
                            setState(() {
                              ...
                              /// Id 6 For the All categories product
                              if (newValue!.id == 6) {
                                callProductListApi();
                              } else {
              ...
              InkWell(
                child: Material(
                  ...
                  child: Container(
                    ...
                    height: 28,
                    child: MaterialButton(onPressed: null, child: Text('CONTACT NOW', style: AppFont.NUNITO_REGULAR_WHITE_10)),
                  ),
                ),
                onTap: () {
